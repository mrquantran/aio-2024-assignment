...
# st.title("MY PROJECT") type: ignore
...
# st.markdown("# Heading 1") type:ignore
...
# st.write('I love AI VIET NAM') type: ignore
# st.write('## Heading 2')
...
# messages = st.container(height=200) type: ignore
